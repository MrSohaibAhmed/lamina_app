    ...
    return (
        ...
        <div className='row rounded-3'>
            <div className=' p-5 rounded-3'>
                ...
                <p className='font-ten'>In this case, you just experienced slippage of 10% because of price fluctuations and it decreased your total buying power. In the scenario above, if the price had fluctuated even more, and TOPG estimates that you would only have received 8 $MOON tokens for your 1 sol, the transaction would have failed, as this was above your slippage setting of 10%.</p>
