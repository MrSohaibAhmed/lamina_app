                                    ...
                                    <div className="row">
                                        <div className="col-lg-12 mx-auto">
                                            <div className="input-group input-group-lg mb-4">
                                                <input type="text" value="657hdguy667687bhgdkahHEGHHHR$%&nnjhse" className="form-control" aria-label="Amount"/>
                                                <span className="input-group-text"><i className="fa fa-copy"></i></span>
                                            </div>
                                        </div>
                                    </div>
