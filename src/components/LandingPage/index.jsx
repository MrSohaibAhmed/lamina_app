        ...
        <div className="container trader-box">
          <div className="row">
            <div className="col-lg-6 align-self-center">
              ...
              <p>Real-time security updates & easily monitor<br className="d-break" /> your portfolio.</p>
        ...
        <div className="container trader-box">
          <div className="row">
            <div className="col-lg-6 align-self-center">
              ...
              <p>Trade faster with Photon with a speed<br className="d-break" /> advantage for every transaction.</p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 text-center">
              <h1 className="main-heading">START TRADINGIN<br /> LESS THAN 30 SECS</h1>
              <p>Install Phantom and connect your wallet to log in.</p>
            </div>
            <div className="col-lg-12 footer-bottom">
              <div className="row">
                ...
                <div className="col-lg-6 text-center text-lg-end"><Link onClick={scrollToTop} >Terms of use </Link> | <Link onClick={scrollToTop}>Privacy policy </Link></div>
              </div>
            </div>
          </div>
        </div>
